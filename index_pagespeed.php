<!-- START Text 1: Main text on page. -->
...
<style>
    ...
    .col-lg-6.col-md-6.col-sm-6.col-xs-12.spring-banner img{
     margin:0 auto;
    }
    @media(max-width:767px){
     .col-lg-3.col-md-3.col-sm-6.col-xs-6.spring-banner img{
      height:16em;
      margin:0 auto;
     }
    }
    ...
    .section1 {
     background: url('/media/banners/2017-holidays/bg1.jpg') no-repeat center center fixed;
     background-size: cover;
     background-color: #fff;
    }
   
    .section2 {
     background: url('/media/banners/2017-holidays/bg2.jpg') no-repeat center center fixed;
     background-size: cover;
     background-color: #52070d;
    }
   
    .section3 {
     background: url('/media/banners/2017-holidays/bg3.jpg') no-repeat center center fixed;
     background-size: cover;
   ...
   <style>
    ...
    #valentines-group, #valentines-group div{
     padding:0px;
    }
   </style>
   <script src="//cdn.sewingmachinesplus.com/AE/jquery-popup/jquery.popupoverlay.js"></script>
    
   <!--<div style="text-align:center;background-color:#5c34a5;">
    <img style="max-width:1292px;width:100%;" src="/media/new-year-2018/new-yearv6.jpg">
   </div>
   <span style="display:block;text-align:center;font-size:12px;margin-top:3px;">*Excludes Sew Steady, Arrow, Dreamworld, Handi Quilter, Janome, Kangaroo, Miele, Reliable, RiCOMA, Melco, industrial machines, & financed orders.</span>-->
   ...
   <div class="col-lg-12 col-md-12 col-sm-12">
    ...
    <style type="text/css">
     @media(min-width:768px){
      .ms-skin-light-6 .ms-bullets.ms-dir-h{     /*remove after march madness*/
       bottom:0!important;
      }
      .exclusion{font-size: 8px !important;}
     }
     #march-madness-phone-order-special-mobile, #march-madness-coupon-codes-mobile {
      display:none;
     }
     @media (max-width: 1024px) {
      ...
      #march-madness-phone-order-special, #march-madness-coupon-codes {
       display:none;
      }
      .exclusion{font-size: 8px !important;}
     }
   ...
   <div align="center" style="font-size: 10px;">*Some product restrictions may apply. Not applicable to products with manufacturer restricted pricing or financed purchases over a 12 month term. Limited to in-stock items. Excludes special orders, backorders, and rain checks. Not applicable to previous purchases, giftcards, classes and events, items with manufacturer controled pricing (MAP), Miele, Janome, Accuquilt, Reliable,Sew Steady, Juki QVP, Industrial Machines, Floriani. Some other product exceptions may apply. Cannot combine with other sale offers.
    ...
    <script>
     ...
     slider.setup('masterslider', {
      width: 1292, // slider standard width
    ...
    <style>
     ...
     /*.test-original-slider{display:block;}
    .test-new-slider{display:none;}*/
     ...
     .spring-banner{padding:10px 0;}
    </style>
    
    <div id="geolocationshipping" style="text-align:center;font-size:2.5em;margin-top:10px;clear:both;">
     <div id="address"></div>
    </div>
   ...
   <!-- /Christmas in July Set 2 -->  
    ...
    <!--RESPONSIVE MINI BANNERS-->
    <!--
    <div class="flex-banner container" style="padding-top:10px;">
     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 side-box-1" style="padding:1%; background-color:#eaeaea; border:solid thin #696969; width:49%;">
      <a href="/tin-lizzie-18-machines.php">
       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 icon-wrap" align="center">
        <img src="/media/hero-banner/discount-icon.png" class="img-responsive icon-img" style="float:left; max-width:90px;">
       </div>
       <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 side-text-wrap" align="center">
        <h2 style="text-align:center; font-weight:bold;">
         <span style="color:#ec010a;">FREE</span> 3 Year Warranty</h2>
        <p class="box-text" style="color:#333333;">All long arm quilting machines come with a FREE 3 year extended warranty. Quilt with confidence!</p>
       </div>
      </a>
     </div>
     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 side-box-2" style="margin-left:1%; padding:1%; background-color:#eaeaea; border:solid thin #696969; width:50%;">
      <a href="/tin-lizzie-18-machines.php">
       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 icon-wrap" align="center">
        <img src="/media/hero-banner/1-dealer-icon.png" class="img-responsive icon-img" style="float:left; max-height:100px;">
       </div>
       <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 side-text-wrap" align="center">
        <h2 style="text-align:center; font-weight:bold;">
         <span style="color:#ec010a; font-weight:bold;">#1</span> Long Arm Dealer in the U.S.</h2>
        <p class="box-text" style="color:#333333;">We are top dealers for Handi Quilter, King Quilter, TinLizzie18, Janome, Juki, Pfaff, Viking, & More!</p>
       </div>
      </a>
     </div>
    </div>
    -->
    <!--SHOP BY TOP LONG ARM QUILTERS-->
    
    <?php include "2017-mm-long-arms-v2.php"; ?>
   ...
   <div class="space-20"></div>
    ...
    <!--SHOP BY TOP EMBROIDERY MACHINES-->
    <?php include "2017-mm-embroidery-v2.php"; ?>
    ...
    <!--SHOP BY TOP SEWING MACHINES-->
    <?php include "2017-mm-sewing-v2.php"; ?>
    ...
    <section class="brand-list">
     <div class="container">
      ...
      <p style="color:#333333; font-size:16px;">You can feel confident when ordering from SewingMachinesPlus.com because we are an authorized retailer of every brand
       we sell. We are recognized by all the top brands as providing expert support and upholding all of their warranty standards.</p>
     </div>
     <div class="container">
      <div class="row">
    ...
    <style>
     ...
     .cagetory-list .category-brand-list-thumb {
    ...
    <div id="new-products-slider">
     <?php include "2017-mm-new-products.php"; ?>
    </div>
    ...
    <script>
     ...
     j(document).ready(function () {
      ...
      j('#geopopup, #financing-pop').popup({
       transition: 'all 0.3s',
       scrolllock: true
      });
     });
     j.get("https://ipinfo.io?token=0423266a427ee0", function (response) {
      if (response.region == "Alabama" || response.region == "Arizona" || response.region == "Arkansas" || response.region ==
       ...
       j("#address").html("<span style='color:red;'>Free Shipping</span> to " + response.region +
        " <a href='#geopopup' class='geopopup_open' style='font-size:16px;color:#0000EE  !important; text-decoration:underline !important;'>See details</a><span style='display:block;clear:left;font-size:16px;margin-top:5px;'>On orders over $49. Most orders ship same day and are delivered within 3-7 business days.</span>"
       );
      } else {
       j("#address").html(
        "<span style='color:red;'>Free Shipping</span> Over $49 <a href='#geopopup' class='geopopup_open' style='font-size:16px;color:#0000EE  !important; text-decoration:underline !important;'>See details</a><span style='display:block;clear:left;font-size:16px;margin-top:5px;'>Most orders ship same day and are delivered within 3-7 business days.</span>"
       );
      }
     }, "jsonp");
    </script>
    ...
    <div id="geopopup" class="container well" style="background-color:#ffffff; max-width:600px;">
     <p style="text-align:center;font-size:2.0em;">FREE Shipping on orders $49 and up.
      <p>
       ...
       <p>Most orders are processed and shipped same day. Orders placed on Friday after 3pm, Saturday, or Sunday are processed
        on Monday. Processing and shipping does not take place on weekends or holidays.</p>
       <p>Within the continental United States (the contiguous 48 states), Shipping is FREE to customers on orders over $49.
        Orders being shipped to Hawaii, Alaska, Canada, APO's, FPO's and DPO's are not eligible for free shipping. Also,
        the free shipping policy does not apply to large or heavy items that require special shipping methods such as assembled
        industrial sewing machines and some sewing cabinets.</p>
       <p>
        <a class="btn btn-secondary btn-lg geopopup_close" style="background-color:#e70000 !important;" href="#" role="button">Close</a>
       </p>
    </div>
    
    <!--QNIQUE PRE ORDERS BANNER-->
    <!--<div class="container">
    <a href="//www.sewingmachinesplus.com/qnique-21.php"/>
    <img style="width:100%;" src="/media/products/grace/qnique-21/qnique21-home-ad.png"/>
    </a>
    </div>-->
    
    <div class="container" style="margin-top:20px;">
     <!--SHOP BY TOP SERGER/OVERLOCK MACHINES-->
     <?php include "2017-mm-sergers-v2.php"; ?>
    
     <!--SHOP BY TOP INDUSTRIAL MACHINES-->
     <?php include "2017-mm-industrial-v2.php"; ?>
    
     <!--SHOP BY TOP FURNITURE-->
     <?php include "2017-mm-furniture-v2.php"; ?>
   ...
   <div id="financing-pop" class="container well" style="background-color:#ffffff; max-width:400px;padding-right:0px;padding-left:0px;">
    <div style="width:100% !important; text-align:center;" class="container">
     ...
     <div id="FAthankyou" style="display:none;clear:both;">
      ...
      <img src="//cdn.sewingmachinesplus.com/media/financing-popup/logo-responsive-mysynchrony2.png"/>
    ...
    <script type="text/javascript">
     ...
     saLoadScript('//www.shopperapproved.com/widgets/group2.0/21959.js');
    </script>

<!-- END Text 1: Main text on page. -->
 ...
 <div class="container">
  <div class="row">
   <div class="col-sm-12">
    <h2 class="section-heading">
     <span>
      <span>Shop by</span><br /> Top Categories
     </span>
    </h2>
...
<!-- START Banner Image: (Page Field 2) -->
...
<!--<a href="//www.sewingmachinesplus.com/promotions-clearance.php"><img src="//cdn.sewingmachinesplus.com/media/promotions/2014-october/page-banner.jpg" border="0"></a>-->

<!--<div align="center">
 <a href="//www.sewingmachinesplus.com/jan14-promotions.php"><img src="//cdn.sewingmachinesplus.com/images/banners/promotions/new-year-new-savings-banner.jpg" border="0"></a><br>
</div>-->
...
<body>
  ...
  <img onLoad="startBanner()" src="/images/layout/new.gif" style="visibility: hidden;display:none;" />

</body>

</html>

<!-- END Banner Image: (Page Field 2) -->
...
<!-- START Head tag (insert JS or CSS): (Page Field 5) -->
...
<link rel="stylesheet" href="/AE/masterslider/skins/light-6/style.css" />
...
<!-- END Head tag (insert JS or CSS): (Page Field 5) -->
...
<!-- Title -->
Sewing, Quilting & Embroidery Machines, Vacuums | SewingMachinesPlus.com 

<!-- File Name -->
index_pagespeed.php

<!-- Meta Keywords -->
Sewingmachines, Sewing Machine, Sewing Machines, Singer, Brother, Janome Sewing Machines, Industrial Overlock Machines, Sewing Machines for Sale

<!-- Meta Description -->
With a huge selection of high quality products and supplies, SewingMachinesPlus.com is the place for all your home and business sewing needs. Shop online today.

<!-- New Site Header: (Page Field 7) -->
SewingMachinesPlus.com

<!-- Page Template -->
-SMP-page-homepage_PageSpeed