													...
													<div>
														...
														[--IF PRODUCT.Field6--]
															<?php
																...
																echo ("<span class='sale-price'>Or <span id='financingprice'><a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>$".$price."<span>/mo* for ".$months."mos**.</span></a></span></span>");
															?>
														[--END_IF--]
														<!--savings display-->
														<?php
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 6 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 12 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 18 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 24 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 36 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 48 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
												...
												<p class="n-link-icon"><span>Financing:</span>
													<span style="color:#313131;">
														...
														<?php
															...
															echo ("<a href='https://www.sewingmachinesplus.com/customer-service.php#fin'>Available @ $".$price."/month* for 60 months**</a>");
														?>
													</span>
												</p>
											[-- END_IF --]
														...
														[--IF PRODUCT.Field18 "new"--]
															<div id="moreInfo">
															  <div class="cbox greybox bord2">
																...
																<p>Now you can relax. With our SewingMachinesPlus.com Platinum Protection Plan, out-of-pocket expenses are completely eliminated for your sewing machine repairs. The plan guarantees to pay all covered parts & labor beyond the original warranty.</p>
																<div class="fcolc">
																  <img src="//cdn.sewingmachinesplus.com/warrantysymbol.gif" class="gal400 bord1" alt="Platinum Protection Warranty Plans" title="Platinum Protection Warranty Plans" />
																</div>
																<div class="cTxt full pad">
																  <h2 class="smp21">Choose Between a 1 Year or 3 Year Warranty</h2>
																  <h4>1 Year Platinum Protection Plan</h4>
																  <p>Covers: parts, labor, and FREE one way shipping.</p>
																  <h4>3 Year Platinum Protection Plan</h4>
																  <p>Covers: parts, labor, FREE round trip shipping the 1st year, and FREE one way shipping the 2nd and 3rd year.</p>
																</div>
																<h4>Warranty Summary</h4>
