  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 margin-b-30" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
        <ul class="list-unstyled phone-contact margin-b-30">
          <li>Toll Free: <strong><a style="color:black;" href="tel:800-401-8151">800-401-8151</a></strong></li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p class="copyright">&copy; 2018 SewingMachinesPlus.com <span class="divider">|</span> <a href="/sitemap_sewingmachineplus.php">Site Map</a></p>
            <!--<p><a href="http://www.americaneagle.com/" target="new">Website design by Americaneagle.com</a></p>--><p>&nbsp;</p>
          </div>
          <div class="col-md-6">
            <img data-src="//cdn.sewingmachinesplus.com/AE/images/footer-logos.png" alt="" class="lazy img-responsive payment">
          </div>
        </div>
      </div>
    </div>
