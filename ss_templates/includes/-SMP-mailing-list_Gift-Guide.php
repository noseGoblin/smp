...
<link href="/AE/css/_pagespeed/mailing-list_giftguide.css" rel="stylesheet">

<section class="newsletter snowglobe">
  <div class="fullwidth bokeh">
    <div class="fullwidth flakes">
      <div class="fullwidth flakey2">
        ...
        <div class="container">
          ...
          <div class="row" id="email-signup-form">
            <div class="col-md-6">
              <h3 style="text-shadow: 1px 1px #fff;">Join our mailing list for Coupons and Promotions!</h3>
            </div>
            <div class="col-md-6">
